...
public class FancyTriangleMaker : MonoBehaviour
{
    ...
    public List<Vector2[]> MakeFancyTriangles(Vector2[] originalPoints) 
    {
        ...
        List<Vector2[]> outputEdges = new List<Vector2[]>();
        ...
        delaunator.ForEachTriangleEdge((edge) => 
        {
            ...
            edgePoints[0] = edge.P.ToVector2();
            edgePoints[1] = edge.Q.ToVector2();
